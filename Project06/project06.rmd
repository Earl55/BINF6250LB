...
def read_fasta(filename: str) -> Dict[str, str]:
    ...
    Returns:
        Dict[str, str]: Dictionary mapping sequence IDs to their sequences.
    """
    sequences = {}
    current_id = None
    with open(filename, 'r') as f:
        for line in f:
            ...
            if not line:
                continue
            if line.startswith('>'):
                # It's a header line, start a new sequence entry
                current_id = line[1:].split()[0] # Use only the first part of the header as ID
                sequences[current_id] = ""
            elif current_id:
                # It's a sequence line, append to the current sequence
